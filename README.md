...
![计算器 · 科学面板](doc/imgs/04.png)

### 单位换算

汇率、长度、重量、温度、房贷等 20+ 换算类型。

![单位换算 · 汇率](doc/imgs/05.png)

![单位换算 · 房贷](doc/imgs/06.png)
...
时间戳与日期互转（上海时区），Base64、URL 编解码，复制带 Toast 提示。

![编码工具 · 时间戳](doc/imgs/08.png)

![编码工具 · Base64 编码](doc/imgs/09.png)

![编码工具 · Base64 解码](doc/imgs/10.png)

![编码工具 · URL 编码](doc/imgs/11.png)

![编码工具 · URL 解码](doc/imgs/12.png)

### 生成工具

随机密码（强度评估）、UUID 批量生成。

![生成工具 · 随机密码](doc/imgs/13.png)

![生成工具 · UUID](doc/imgs/14.png)

### 二维码

上传图片解析、文本生成 PNG，SQLite 历史与时间筛选。

![二维码 · 解析](doc/imgs/15.png)

![二维码 · 生成](doc/imgs/16.png)

### 开发工具

正则表达式测试（常用预设 + 高亮匹配），Cron 表达式解析。

![开发工具 · 正则](doc/imgs/17.png)

![开发工具 · Cron](doc/imgs/18.png)

### 身份证工具

解析、校验、批量生成，支持地区与出生年份配置。

![身份证 · 解析](doc/imgs/19.png)

![身份证 · 生成](doc/imgs/20.png)

### 设置

开机自启、托盘、快捷键、主题、数据目录与自动更新。

![设置 · 通用](doc/imgs/21.png)

![设置 · 高级](doc/imgs/22.png)

![设置 · 关于](doc/imgs/23.png)
